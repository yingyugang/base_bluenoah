...
public class UIEditorSettings : ScriptableObject
{
	...
	public string CLASS_NAMESPACE = "BlueNoah.UI";
	public string CTRL_CLASS_SUFFIX = "Ctrl";
	public string VIEW_CLASS_SUFFIX = "View";

    public Object DIALOG_PREFAB_FOLDER_PATH;
    public Object DIALOG_CLASS_PATH;
    public List<GameObject> PREFAB_DIALOG_TEMPLATES;
    public TextAsset SCRIPT_TEMPLATE_DIALOG;
    public string DIALOG_CLASS_SUFFIX = "Dialog";
}
